...
#define BSP_TZ_CFG_PSARB                                                                           \
	((((RA_NOT_DEFINED > 0) ? 0U : 1U) << 4) /* I3C */ |                                       \
	 ...
	 (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 12) /* USBHS */ | (1 << 15) /* ETHERC/EDMAC */ |     \
	 (1 << 16) /* OSPI */ | (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 18) /* SPI1 */ |              \
...
/* The LVD driver needs to access both channels. This means that the security attribution for both
 ...
 * Trusted Event Route Control is not supported.
 */
...
#define BSP_CFG_ROM_REG_FSBLCTRL1 ((3 << R_OFS_DATAFLASH_FSBLCTRL1_FSBLEXMD_Pos) | 0xFFFFFFFC)
#endif
...
#define BSP_CFG_ROM_REG_ARCLS                                                                      \
	((RA_NOT_DEFINED << R_OFS_DATAFLASH_ARCLS_ARCS_LK_Pos) |                                   \
	 ...
	 (RA_NOT_DEFINED << R_OFS_DATAFLASH_ARCLS_ARCBL_LK_Pos) | 0xFFC0)
#endif

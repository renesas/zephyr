...
#ifndef ZEPHYR_INCLUDE_TOOLCHAIN_ICCRH850_H_
#define ZEPHYR_INCLUDE_TOOLCHAIN_ICCRH850_H_

/**
 * @file
 * @brief ICCRH850 toolchain abstraction
 *
 * Macros to abstract compiler capabilities for ICCRH850 toolchain.
 */

/* ICCRH850 supports its own #pragma diag_{warning,default,error,warning}. */
...
/* TG-WG: ICCRH850 does not support __fallthrough */
...
#ifndef __must_check
/* #warning "The attribute __warn_unused_result is not supported in ICCRH850". */
#define __must_check
...
/* __weak is an ICCRH850 built-in, but it doesn't work in all positions */
...
/* These macros allow having RH850 asm functions callable from thumb */
...
#endif /* !_LINKER */
#endif /* ZEPHYR_INCLUDE_TOOLCHAIN_ICCRH850_H_ */

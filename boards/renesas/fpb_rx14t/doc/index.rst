...
Support for building RXv2 and RXv3 cores is available starting from Zephyr SDK v1.0.0.
Please ensure that Zephyr SDK v1.0.0 or later is used when building for the FPB-RX14T board.

Or use the cross-compile by:
  ...
  - Build the Blinky Sample for FPB-RX14T

   .. code-block:: console

      cd ~/zephyrproject/zephyr
      west build -p always -b fpb_rx14t samples/basic/blinky

...
Please ensure that Zephyr SDK v1.0.0 or later is used when building for the MCB-RX14T board.
...
Or use the cross-compile by:
  ...
  - Build the Blinky Sample for MCB-RX14T

   .. code-block:: console

      cd ~/zephyrproject/zephyr
      west build -p always -b mcb_rx14t samples/basic/blinky

...
elseif(EXISTS ${IAR_TOOLCHAIN_PATH}/bin/iccarm.exe)
  ...
  set(IAR_COMPILER iccarm)
  set(IAR_LINKER ilinkarm)
elseif(EXISTS ${IAR_TOOLCHAIN_PATH}/bin/iccrh850)
  message(STATUS "Found toolchain: IAR C/C++ Compiler for RH850 (${IAR_TOOLCHAIN_PATH})")
  set(IAR_COMPILER iccrh850)
  set(IAR_LINKER ilinkrh850)
elseif(EXISTS ${IAR_TOOLCHAIN_PATH}/bin/iccrh850.exe)
  message(STATUS "Found toolchain: IAR C/C++ Compiler for RH850 (${IAR_TOOLCHAIN_PATH})")
  set(IAR_COMPILER iccrh850)
  set(IAR_LINKER ilinkrh850)
endif()

...
elseif("${IAR_TOOLCHAIN_VARIANT}" STREQUAL "iccrh850")
  set(IAR_ZEPHYR_HOME ${IAR_TOOLCHAIN_PATH}/bin)
else()
...
elseif("${IAR_TOOLCHAIN_VARIANT}" STREQUAL "iccrh850")
  find_program(CMAKE_OBJCOPY  ielftool                PATHS ${IAR_ZEPHYR_HOME} NO_DEFAULT_PATH)
  find_program(CMAKE_OBJDUMP  ielfdumprh850           PATHS ${IAR_ZEPHYR_HOME} NO_DEFAULT_PATH)
  find_program(CMAKE_AS       iasmrh850               PATHS ${IAR_ZEPHYR_HOME} NO_DEFAULT_PATH)
  find_program(CMAKE_AR       iarchive                PATHS ${IAR_ZEPHYR_HOME} NO_DEFAULT_PATH)
  find_program(CMAKE_RANLIB   iarchive                PATHS ${IAR_ZEPHYR_HOME} NO_DEFAULT_PATH)
  find_program(CMAKE_READELF  ielfdumprh850           PATHS ${IAR_ZEPHYR_HOME} NO_DEFAULT_PATH)
  find_program(CMAKE_NM       ielfdumprh850           PATHS ${IAR_ZEPHYR_HOME} NO_DEFAULT_PATH)
  find_program(CMAKE_STRIP    ielftool                PATHS ${IAR_ZEPHYR_HOME} NO_DEFAULT_PATH)
else()
  message(ERROR "IAR_TOOLCHAIN_VARIANT not set")
endif()

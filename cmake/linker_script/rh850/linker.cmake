...
# Set alignment to CONFIG_RH850_MPU_REGION_MIN_ALIGN_AND_SIZE if not set above
# to make linker section alignment comply with MPU granularity.
if(DEFINED CONFIG_RH850_MPU_REGION_MIN_ALIGN_AND_SIZE)
  set_ifndef(region_min_align ${CONFIG_RH850_MPU_REGION_MIN_ALIGN_AND_SIZE})
endif()
...
zephyr_linker(FORMAT "elf32-little")
...
zephyr_linker_section(NAME .irq_vector_table GROUP ROM_REGION NOINPUT)
...
zephyr_linker_section(NAME .TP_BLOCK GROUP RODATA_REGION)
zephyr_linker_section(NAME .pcconst32 GROUP RODATA_REGION)
...
if(CONFIG_USERSPACE)
  ...
  zephyr_linker_symbol(SYMBOL "__app_smem_size" EXPR "@___app_smem_group_size@")
	zephyr_linker_symbol(SYMBOL "__app_smem_rom_start" EXPR "@___app_smem_group_load_start@")
...
zephyr_linker_symbol(SYMBOL ___ramfunc_region_start EXPR "(@___ramfunc_start@)")
zephyr_linker_symbol(SYMBOL ___kernel_ram_start EXPR "(@___bss_start@)")
zephyr_linker_symbol(SYMBOL ___kernel_ram_end  EXPR "(${RAM_ADDR} + ${RAM_SIZE})")
zephyr_linker_symbol(SYMBOL ___kernel_ram_size EXPR "(@___kernel_ram_end@ - @___bss_start@)")
zephyr_linker_symbol(SYMBOL __image_ram_start  EXPR "(${RAM_ADDR})" SUBALIGN 32) # ToDo calculate 32 correctly
zephyr_linker_symbol(SYMBOL _RH850_LIB_STACKHEAP EXPR "(${RAM_ADDR} + ${RAM_SIZE})" SIZE -0x1000)
...
zephyr_linker_section_configure(
  ...
  INPUT ".gnu.linkonce.irq_vector_table*"
  KEEP FIRST

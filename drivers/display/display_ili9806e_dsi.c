...
#define ILITEK_ILI9806E_COLMOD_RGB565 0x0A
...
static int ili9806e_write(const struct device *dev, uint16_t x, uint16_t y,
...
static const struct display_driver_api ili9806e_api = {
	.blanking_on = ili9806e_blanking_on,
	.blanking_off = ili9806e_blanking_off,
	.write = ili9806e_write,
...
#define ILITEK_ILI9806E_DEFINE(n)                                                                  \
	...
	DEVICE_DT_INST_DEFINE(n, &ili9806e_init, NULL, NULL, &ili9806e_config_##n, POST_KERNEL,    \
			      CONFIG_APPLICATION_INIT_PRIORITY, &ili9806e_api);

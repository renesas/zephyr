...
#define LCD_HTIMMING_TOTAL_CYC  DT_PROP(DT_NODELABEL(zephyr_lcdif), htiming_total_cyc)
...
#define LCD_VTIMMING_TOTAL_CYC  DT_PROP(DT_NODELABEL(zephyr_lcdif), vtiming_total_cyc)

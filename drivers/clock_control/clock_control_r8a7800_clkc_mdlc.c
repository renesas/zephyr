...
static struct clkc_clk_info_table mod_props[] = {
	...
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_MPPHY01, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_MPPHY11, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_MPPHY21, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_MPPHY31, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_MPPHY02, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
};

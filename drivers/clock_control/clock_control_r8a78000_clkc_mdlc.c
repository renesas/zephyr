...
static struct clkc_clk_info_table core_props[] = {
	RCAR_CORE_CLK_INFO_ITEM(R8A78000_CLK_S0D8_HSCN_PPCI4, RCAR_CLKC_NONE, RCAR_CLKC_NONE,
				RCAR_CLKC_NONE, RCAR_CLKC_MHZ(100)),
	RCAR_CORE_CLK_INFO_ITEM(R8A78000_CLK_RSWCORECK_HSCN_RSW3_AES, RCAR_CLKC_NONE,
				RCAR_CLKC_NONE, RCAR_CLKC_NONE, RCAR_CLKC_KHZ(712500)),
...
static struct clkc_clk_info_table mod_props[] = {
	...
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_XPCS0, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_XPCS1, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_XPCS2, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_XPCS3, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_XPCS4, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_XPCS5, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_XPCS6, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_XPCS7, RCAR_CLKC_NONE, RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_MPPHY01, R8A78000_CLK_S0D8_HSCN_PPCI4,
			       RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_MPPHY11, R8A78000_CLK_S0D8_HSCN_PPCI4,
			       RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_MPPHY21, R8A78000_CLK_S0D8_HSCN_PPCI4,
			       RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_MPPHY31, R8A78000_CLK_S0D8_HSCN_PPCI4,
			       RCAR_CLKC_CAP_STOP),
	RCAR_MOD_CLK_INFO_ITEM(R8A78000_MOD_MPPHY02, R8A78000_CLK_S0D8_HSCN_PPCI4,
			       RCAR_CLKC_CAP_STOP),
};

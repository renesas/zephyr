...
{
#if defined(CONFIG_RSPI_INTERRUPT)
...
#if !defined(CONFIG_RSPI_INTERRUPT) && !defined(CONFIG_RSPI_RZ_DMAC)
...
#endif /* #if !defined(CONFIG_RSPI_INTERRUPT) && !defined(CONFIG_RSPI_RZ_DMAC) */
...
#elif defined(CONFIG_RSPI_INTERRUPT)
#define RZ_RSPI_IRQ_INIT(n)                                                                        \
	do {                                                                                       \
...
#define SPI_RZ_RSPI_INIT(n)                                                                        \
	...
	IF_ENABLED(CONFIG_RSPI_RZ_DMAC,                                                         \
	...
	static spi_cfg_t g_spi_##n##_config = {                                                    \
		...
		COND_CODE_1(CONFIG_RSPI_RZ_DMAC,                                                   \
			(                                                                          \

...
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 3)
static __aligned(32) uint8_t g_ether0_ether_buffer2[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 4)
static __aligned(32) uint8_t g_ether0_ether_buffer3[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 5)
static __aligned(32) uint8_t g_ether0_ether_buffer4[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 6)
static __aligned(32) uint8_t g_ether0_ether_buffer5[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 7)
static __aligned(32) uint8_t g_ether0_ether_buffer6[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 8)
static __aligned(32) uint8_t g_ether0_ether_buffer7[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 9)
static __aligned(32) uint8_t g_ether0_ether_buffer8[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 10)
static __aligned(32) uint8_t g_ether0_ether_buffer9[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 11)
static __aligned(32) uint8_t g_ether0_ether_buffer10[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 12)
static __aligned(32) uint8_t g_ether0_ether_buffer11[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 13)
static __aligned(32) uint8_t g_ether0_ether_buffer12[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 14)
static __aligned(32) uint8_t g_ether0_ether_buffer13[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 15)
static __aligned(32) uint8_t g_ether0_ether_buffer14[ETHER_BUF_SIZE];
#endif
#if ((ETHER_TOTAL_BUF_NUM) >= 16)
static __aligned(32) uint8_t g_ether0_ether_buffer15[ETHER_BUF_SIZE];
#endif
...
void renesas_ra_eth_callback(ether_callback_args_t *p_args)
{
	...
	if (p_args->status_eesr & ETHER_ISR_EE_RECEIVE_EVENT_MASK) {

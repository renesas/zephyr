...
#define DAC_DA_AD_SYNCHRONIZE_PARAMETER                                                            \
	COND_CODE_1(CONFIG_DAC_RENESAS_RA_DA_AD_SYNCHRONIZE,                                       \
	(.ad_da_synchronized = true), (.ad_da_synchronized = false))
...
#endif
#define DAC_DAVREFCR_PARAMETER .ref_volt_sel = DAC_RENESAS_RA_DAVREFCR
#else
#define DAC_DAVREFCR_PARAMETER .ref_volt_sel = 0
#endif
	...
	static struct dac_renesas_ra_data dac_renesas_ra_data_##idx = {                            \
		...
		.f_config =                                                                        \
			{                                                                          \
				...
				DAC_DA_AD_SYNCHRONIZE_PARAMETER,                                   \

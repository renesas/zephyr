...
#define UHC_RENESAS_RA_DEVICE_DEFINE(n)                                                            \
	...
	static struct uhc_renesas_ra_data uhc_priv_data_##n = {                                    \
		...
		.uhc_cfg =                                                                         \
			{                                                                          \
				...
				.hs_irq =                                                          \
					RENESAS_RA_USB_IRQ_GET(DT_INST_PARENT(n), usbhs_ir, irq),  \
				.ipl = RENESAS_RA_USB_IRQ_GET(DT_INST_PARENT(n), usbfs_i,          \
							      priority),                           \
				.ipl_r = RENESAS_RA_USB_IRQ_GET(DT_INST_PARENT(n), usbfs_r,        \
								priority),                         \
				.hsipl = RENESAS_RA_USB_IRQ_GET(DT_INST_PARENT(n), usbhs_ir,       \
								priority),                         \
	...
	{                                                                                          \
		LISTIFY(DT_NUM_IRQS(DT_INST_PARENT(n)),   \
			RENESAS_RA_USB_IRQ_CONNECT, (;), n);          \

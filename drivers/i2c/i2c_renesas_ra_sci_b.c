...
#define SCI_B_I2C_RA_INIT(index)                                                                     \
	...
	static struct sci_b_i2c_data sci_b_i2c_data_##index = {                                      \
		.i2c_config = {                                                                      \
			...
			.rxi_irq = COND_CODE_1(CONFIG_I2C_RENESAS_RA_SCI_B_DTC,            \
				...
				.ext_cfg =                                                           \
					{                                                            \
						.clock_settings.snfr_value = DT_INST_PROP(           \
							index, noise_filter_clock_select),           \
						.clock_settings.bitrate_modulation =                 \
							DT_INST_NODE_HAS_PROP(                       \
								DT_DRV_INST(index),                  \
								bit_rate_modulation),                \
						.clock_settings.clock_source =                       \
							SCI_B_I2C_CLOCK_SOURCE_SCISPICLK,            \
					},                                                           \
	...
	I2C_DEVICE_DT_INST_DEFINE(index, sci_b_i2c_init_##index, PM_DEVICE_DT_INST_GET(index),       \
				  &sci_b_i2c_data_##index, &sci_b_i2c_config_##index, POST_KERNEL,   \

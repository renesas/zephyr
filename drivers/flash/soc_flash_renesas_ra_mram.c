...
#define SOC_NV_FLASH_NODE DT_INST_CHILD(0, mram_2000000)
...
static struct mram_renesas_ra_controller_config mram_controller_config = {
	.mram_parameters = {.write_block_size = DT_PROP(SOC_NV_FLASH_NODE, write_block_size),
			    .erase_value = 0xff,
	...
	.start_address = DT_REG_ADDR(SOC_NV_FLASH_NODE),
#ifdef CONFIG_FLASH_PAGE_LAYOUT

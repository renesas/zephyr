...
static inline void mipi_dsi_renesas_ra_pm_policy_state_lock_get(void)
{
	pm_policy_state_lock_get(PM_STATE_SUSPEND_TO_IDLE, PM_ALL_SUBSTATES);
	pm_policy_state_lock_get(PM_STATE_STANDBY, PM_ALL_SUBSTATES);
}

static inline void mipi_dsi_renesas_ra_pm_policy_state_lock_put(void)
{
				      ...
				      const struct mipi_dsi_device *mdev)
{
	...
	/* TODO: add pm_device_busy_clear() after implementing the detach API */
					     ...
					     struct mipi_dsi_msg *msg)
{
	...
	mipi_dsi_renesas_ra_pm_policy_state_lock_get();
	k_sem_take(&data->in_transmission, K_FOREVER);
	mipi_dsi_renesas_ra_pm_policy_state_lock_put();
